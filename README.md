...
В проекте в качестве основного фреймворка использован **aiogram==2.25.1**.
Для получения курса валют использовано Exchange Rates Data API.
Для получения прогноза погоды API Openweather.
